...
document.getElementById('btn-sign-in').addEventListener('click', function(event) {
    ...
    .then(data => {
        ...
        formContainer.innerHTML = data.sign_in.form_log_in; // Asumimos que en el JSON, form_log_in es HTML
